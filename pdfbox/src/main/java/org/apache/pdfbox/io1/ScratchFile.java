...
import org.apache.pdfbox.io1.MemoryUsageSetting;
import org.apache.pdfbox.io1.RandomAccess;
...
public class ScratchFile implements Closeable
{
     ...
     */
    public org.apache.pdfbox.io1.RandomAccess createBuffer() throws IOException
    {
        return new ScratchFileBuffer(this);
    }

//    public org.apache.pdfbox.io.io2.RandomAccess createBuffer() throws IOException
//    {
//        return new ScratchFileBuffer(this);
//    }
    ...
    {
        org.apache.pdfbox.io1.ScratchFileBuffer buf = new org.apache.pdfbox.io1.ScratchFileBuffer(this);
