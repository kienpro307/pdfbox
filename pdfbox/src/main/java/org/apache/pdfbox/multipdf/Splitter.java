...
public class Splitter
{
    ...
    private void cloneStructureTree(PDDocument destinationDocument) throws IOException
    {
        ...
        for (int p = 0; p < dstPageTree.getCount(); ++p)
        {
            ...
            for (PDAnnotation ann : page.getAnnotations())
            {
                ...
                {
                    processResources(normalAppearanceStream.getResources(), srcNumberTreeAsMap, dstNumberTreeAsMap, new HashSet<COSDictionary>());
                }
            }
            processResources(page.getResources(), srcNumberTreeAsMap, dstNumberTreeAsMap, new HashSet<COSDictionary>());
        }
            ...
            throws IOException
    {
        ...
        for (Map.Entry<String, PDStructureElement> entry : srcIDTreeAsMap.entrySet()) {
            ...
            PDStructureElement val = entry.getValue();
