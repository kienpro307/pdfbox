 ...
 * @author Timo Boehme
 */
public class RandomAccessReadBufferedFile implements org.apache.pdfbox.io.io2.RandomAccessRead
{
    ...
    {
        for (RandomAccessReadBufferedFile buffer : rafCopies.values()) {
